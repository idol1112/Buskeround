...
public class BlogVo {
	...
	public BlogVo(int user_no, String id, String nickname, String user_img, int genre, String intro, String banner,
			String y_url, String f_url, String i_url, int likes, boolean likeOk, int fan, boolean fanOk, int artist_no,
			int live) {
		super();
	...
	public String toString() {
		return "BlogVo [user_no=" + user_no + ", id=" + id + ", nickname=" + nickname + ", user_img=" + user_img
				...
				+ f_url + ", i_url=" + i_url + ", likes=" + likes + ", likeOk=" + likeOk + ", fan=" + fan + ", fanOk="
				+ fanOk + ", artist_no=" + artist_no + ", live=" + live + "]";
	}
