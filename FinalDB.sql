...
--아티스트들 생성
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'busker', 'busker123', 'busker@naver.com', '장범준', '10.jpg', '장범준', '010-1204-0235', 'male', '1989-05-16', '1', '인디밴드', '1', 984, 984, sysdate, '2', '1');
...
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'ccc', '1234', 'ccc@naver.com', '박서준', '8.PNG', '박서준', '010-1234-5000', 'male', '19970216', '1', '솔로', '1', 1550, 1550, sysdate, '2', '1');
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'ddd', '1234', 'ddd@naver.com', '제니', '52.PNG', '김제니', '010-9978-0345', 'female', '19960520', '2', '솔로가수', '1', 1240, 1240, sysdate, '2', '1');
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'eee', '1234', 'eee@naver.com', '이여름', '53.PNG', '이여름', '010-6720-0080', 'female', '19981109', '5', '솔로', '1', 1100, 1100, sysdate, '2', '1');
...
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'ggg', '1234', 'ggg@naver.com', 'ROSE', '20.PNG', '박채영', '010-3212-1065', 'female', '19960211', '4', 'KPOP', '1', 1350, 1350, sysdate, '2', '1');
...
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'kkk', '1234', 'kkk@naver.com', '양요섭', '48.PNG', '양요섭', '010-2723-4377', null, '19960129', '1', '발라드가수', '0', 1400, 1400, sysdate, '2', '1');
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'lll', '1234', 'lll@naver.com', 'TWICE', '44.PNG', '김나연', '010-5512-8530', 'female', '19961209', '3', '솔로', '0', 1300, 1300, sysdate, '2', '1');
...
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'ooo', '1234', 'ooo@naver.com', '김선호', '4.PNG', '김선호', '010-3677-8989', 'male', '20010628', '4', '솔로', '0', 1500, 1500, sysdate, '2', '1');
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'zzz', '1234', 'zzz@naver.com', '김동호', '6.PNG', '김동호', '010-2998-0001', 'male', '20000101', '1', '솔로', '0', 1600, 1600, sysdate, '2', '1');
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'PPP', '1234', 'PPP@naver.com', 'ICON', '49.PNG', '박정진', '010-5656-3788', 'male', '19950326', '3', '힙합', '0', 1450, 1450, sysdate, '2', '1');
...
insert INTO users(user_no, id, password, email, nickname, user_img, name, hp, gender, birthday, genre, genre_type, live, fan, likes, artist_regdate, user_type, company_type) VALUES (seq_user_no.nextval, 'rrr', '1234', 'rrr@naver.com', '홀리뱅', '14.PNG', '홀리뱅', '010-2280-1445', 'female', '19940513', '6', '행위예술', '0', 1200, 1200, sysdate, '2', '1');
