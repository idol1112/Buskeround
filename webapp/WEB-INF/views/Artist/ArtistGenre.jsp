                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="${pageContext.request.contextPath}/assets/image/artist/icon/dance.png" style="width:70px">
                            </td>
                            <td>
                                <div>활동유형 비보잉</div>
                                <div>가입연도 2020년</div>
                        ...
                        <tr>
                            <td>6</td>
                            <td>
                                <img src="${pageContext.request.contextPath}/assets/image/artist/img/7.PNG" style="width:80px">
                            </td>
                            <td>
                                <div>선미(SUNMI)</div>
                                <div>
                        ...
                        <tr>
                            <td>7</td>
                            <td>
                                <img src="${pageContext.request.contextPath}/assets/image/artist/img/10.PNG" style="width:80px">
                            </td>
                            <td>
                                <div>웨이비</div>
                                <div>
