					...
					<tbody>
						<c:forEach items="${artistRenkList}" var="aList">
							...
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath}/blog/blog_main/${aList.id}">${aList.nickname}</a>
								</td>
								<!-- 장르 -->
								...
								<c:choose>
									<c:when test="${aList.likeOk == true}">
										<td class="left02_td"><img class="likes" data-no="${aList.user_no}" src="${pageContext.request.contextPath}/assets/image/artist/icon/heart2.png" style="width: 20px"> <span class="likes2-${aList.user_no}">${aList.likes}</span></td>
									</c:when>
									<c:otherwise>
										<td class="left02_td"><img class="likes" data-no="${aList.user_no}" src="${pageContext.request.contextPath}/assets/image/artist/icon/heart1.png" style="width: 20px"> <span class="likes2-${aList.user_no}">${aList.likes}</span></td>
									</c:otherwise>
								</c:choose>
								...
								<c:choose>
									...
									<c:otherwise>
										<td class="left02_td"><img class="fan" data-no="${aList.user_no}" src="${pageContext.request.contextPath}/assets/image/artist/icon/fan1.png" style="width: 20px"><span class="fan2-${aList.user_no}">${aList.fan}</span></td>
									</c:otherwise>
								</c:choose>
